...
<table>
    ...
    <tr>
        ...
        <td>
            <form method="post" action='<c:url value="/deleteMonth?idMonth=${month.id}&year=${requestScope.year}" />'
...
<a href="createMonth?year=${requestScope.year}"><fmt:message key="create"/></a>
